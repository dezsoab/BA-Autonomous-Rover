...
class MotorDriver:
    ...
    def set_speed(self, target_speed):
        ...
        """
        target_speed = max(MIN_SPEED, min(target_speed, MAX_SPEED)) # Make sure to respect -1.0 to 1.0 limits for motor safety
    ...
    def cleanup(self):
        ...
        """
        self.set_speed(0.0) # Smooth stop first
        self.STBY.off()     # Hard cut power to the driver
        self.STBY.close()   # Release the GPIO pin
